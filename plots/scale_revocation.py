...
def scale_revocations(totalVCs):
    ...
    plt.errorbar(x1points, y1points, marker='o', color='#614415', label="fpr=0.1", yerr=ey1points)
    plt.errorbar(x1points, y2points, marker='d', color='#0072b2', label="fpr=0.01", yerr=ey2points)
    plt.errorbar(x1points, y3points, marker='*', color='#d55e00', label="fpr=0.001", yerr=ey3points)
    plt.errorbar(x1points, y4points, marker='+', color='#009e73', label="fpr=0.0001", yerr=ey4points)
    # plt.yticks(yRange, ylabel)
    # plt.xticks(x1points, xlabel)
    plt.title('Total VCs: '+str(totalVCs), font)
    plt.xlabel('number of revocations', font)
