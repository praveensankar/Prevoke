...
// CheckRevocationStatusInBloomFilter is a free data retrieval call binding the contract method 0x5b688264.
//
// Solidity: function checkRevocationStatusInBloomFilter(uint256[1] _indexes) view returns(bool)
func (_RevocationService *RevocationServiceCaller) CheckRevocationStatusInBloomFilter(opts *bind.CallOpts, _indexes [1]*big.Int) (bool, error) {
	var out []interface{}
...
//
// Solidity: function checkRevocationStatusInBloomFilter(uint256[1] _indexes) view returns(bool)
func (_RevocationService *RevocationServiceSession) CheckRevocationStatusInBloomFilter(_indexes [1]*big.Int) (bool, error) {
...
//
// Solidity: function checkRevocationStatusInBloomFilter(uint256[1] _indexes) view returns(bool)
func (_RevocationService *RevocationServiceCallerSession) CheckRevocationStatusInBloomFilter(_indexes [1]*big.Int) (bool, error) {
	return _RevocationService.Contract.CheckRevocationStatusInBloomFilter(&_RevocationService.CallOpts, _indexes)
}
...
// VerificationPhase1 is a free data retrieval call binding the contract method 0x4bd35c65.
//
// Solidity: function verificationPhase1(uint256[1] _bfIndexes) view returns(bool)
func (_RevocationService *RevocationServiceCaller) VerificationPhase1(opts *bind.CallOpts, _bfIndexes [1]*big.Int) (bool, error) {
	var out []interface{}
...
//
// Solidity: function verificationPhase1(uint256[1] _bfIndexes) view returns(bool)
func (_RevocationService *RevocationServiceSession) VerificationPhase1(_bfIndexes [1]*big.Int) (bool, error) {
...
//
// Solidity: function verificationPhase1(uint256[1] _bfIndexes) view returns(bool)
func (_RevocationService *RevocationServiceCallerSession) VerificationPhase1(_bfIndexes [1]*big.Int) (bool, error) {
	return _RevocationService.Contract.VerificationPhase1(&_RevocationService.CallOpts, _bfIndexes)
}
...
// RevokeVC is a paid mutator transaction binding the contract method 0xe309196f.
//
// Solidity: function revokeVC(uint256[1] _bfIndexes, uint256[] _mtIndexes, bytes32[] _mtValues) returns()
func (_RevocationService *RevocationServiceTransactor) RevokeVC(opts *bind.TransactOpts, _bfIndexes [1]*big.Int, _mtIndexes []*big.Int, _mtValues [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function revokeVC(uint256[1] _bfIndexes, uint256[] _mtIndexes, bytes32[] _mtValues) returns()
func (_RevocationService *RevocationServiceSession) RevokeVC(_bfIndexes [1]*big.Int, _mtIndexes []*big.Int, _mtValues [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function revokeVC(uint256[1] _bfIndexes, uint256[] _mtIndexes, bytes32[] _mtValues) returns()
func (_RevocationService *RevocationServiceTransactorSession) RevokeVC(_bfIndexes [1]*big.Int, _mtIndexes []*big.Int, _mtValues [][32]byte) (*types.Transaction, error) {
	return _RevocationService.Contract.RevokeVC(&_RevocationService.TransactOpts, _bfIndexes, _mtIndexes, _mtValues)
}
...
// UpdateBloomFilter is a paid mutator transaction binding the contract method 0x56e7f37a.
//
// Solidity: function updateBloomFilter(uint256[1] _indexes) returns()
func (_RevocationService *RevocationServiceTransactor) UpdateBloomFilter(opts *bind.TransactOpts, _indexes [1]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function updateBloomFilter(uint256[1] _indexes) returns()
func (_RevocationService *RevocationServiceSession) UpdateBloomFilter(_indexes [1]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function updateBloomFilter(uint256[1] _indexes) returns()
func (_RevocationService *RevocationServiceTransactorSession) UpdateBloomFilter(_indexes [1]*big.Int) (*types.Transaction, error) {
	return _RevocationService.Contract.UpdateBloomFilter(&_RevocationService.TransactOpts, _indexes)
}
