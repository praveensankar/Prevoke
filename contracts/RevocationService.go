...
// VerificationPhase1 is a free data retrieval call binding the contract method 0xa6e9a931.
//
// Solidity: function verificationPhase1(uint256[3] _bfIndexes) view returns(bool)
func (_RevocationService *RevocationServiceCaller) VerificationPhase1(opts *bind.CallOpts, _bfIndexes [3]*big.Int) (bool, error) {
	var out []interface{}
...
//
// Solidity: function verificationPhase1(uint256[3] _bfIndexes) view returns(bool)
func (_RevocationService *RevocationServiceSession) VerificationPhase1(_bfIndexes [3]*big.Int) (bool, error) {
...
//
// Solidity: function verificationPhase1(uint256[3] _bfIndexes) view returns(bool)
func (_RevocationService *RevocationServiceCallerSession) VerificationPhase1(_bfIndexes [3]*big.Int) (bool, error) {
	return _RevocationService.Contract.VerificationPhase1(&_RevocationService.CallOpts, _bfIndexes)
}
