...
//}
//
//func Sign(privateKey *bbs12381g2pub.PrivateKey, messages [][]byte) []byte{
...
//}
//
//func Verify(publicKey *bbs12381g2pub.PublicKey, signature []byte, messages [][]byte) bool{
//	//verifier, err := bbs.NewVerifier(publicKey)
//	//if err != nil{
//	//	zap.S().Infoln("BBS - error creating verifier: ",err)
//	//}
//	err := .(messages, signature)
//	if err != nil {
...
//	(nonce) - []byte
//*/
//func SelectiveDisclosure(verifier *subtle.BLS12381G2Verifier, signature []byte, messages [][]byte, revealedIndexes []int) ([]byte, []byte ){
//	//verifier, err := bbs.NewVerifier(publicKey)
//	//if err != nil{
//	//	zap.S().Infoln("BBS - error creating verifier: ",err)
//	//}
...
//}
//
//func VerifySelectiveDisclosureProof(verifier *subtle.BLS12381G2Verifier,  proof []byte, selectiveMessages [][]byte, nonce []byte) bool{
//	//verifier, err := bbs.NewVerifier(publicKey)
//	//if err != nil{
//	//	zap.S().Infoln("BBS - error creating verifier: ",err)
//	//}
...
//	public key - string
// */
//func PublicKeyToString(publicKey *bbs12381g2pub.PublicKey) string{
